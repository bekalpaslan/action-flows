...
- [x] 10-04-PLAN.md -- Self-healing flows: HealingQuotaTracker, HealingService, healingStore, HealingApprovalCard, CircuitBreakerNotice
...
### Phase 999.1: History & Memory Lifecycle Management
...
- [x] 999.1-02-PLAN.md -- LedgerService (append/query) + summarizeTrace pure function
- [x] 999.1-03-PLAN.md -- HealthScoreCalculator.prune() + CleanupService raw->ledger promotion wiring
- [x] 999.1-04-PLAN.md -- LearningsArchiver (50-entry cap, year-scoped archive) + CleanupService wiring
- [x] 999.1-05-PLAN.md -- GET /api/history/ledger route with filters
