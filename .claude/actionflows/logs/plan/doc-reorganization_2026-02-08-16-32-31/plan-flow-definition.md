# Flow Definition: Documentation Reorganization

## Complete Flow Instructions.md Content

Below is the complete content for `.claude/actionflows/flows/framework/doc-reorganization/instructions.md`:
